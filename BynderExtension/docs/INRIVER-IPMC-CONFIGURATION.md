...
| LOCALE_MAPPINGS_INRIVER_TO_BYNDER | {"en-GB":"en","nl-NL":"nl"} | Mappings from inRiver language codes to Bynder language codes. Used when uploading metadata to Bynder (LocaleString / CVL of LocaleString) |
