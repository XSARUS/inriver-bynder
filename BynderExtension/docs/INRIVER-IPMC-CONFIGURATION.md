...
| IMPORT_CONDITIONS | [{"propertyName": "synctoinriver", "values":["True"]}] | filter assets that must be imported with the NotificationListener and the AssetLoader. Filtering will be applied after getting the Asset.
